...
import { ReportDataGridAG, type ComparisonMode } from "./report-data-grid-ag"
...
export function OrganizationTreeView({ comparisonMode }: OrganizationTreeViewProps) {
  ...
  return (
    <div className="flex h-full">
      ...
      {/* Right Content - AG Grid */}
      <div className="flex-1 min-w-0 overflow-hidden">
        <ReportDataGridAG organizationId={selectedOrgId} comparisonMode={comparisonMode} />
      </div>
    </div>
  )
}
