...
// モックデータ: 見込用の行（TreeGrid用に親子関係を設定）
const mockForecastRows: BffForecastRow[] = [
  {
    rowId: "row-sales",
    subjectId: "sub-sales",
    subjectCode: "1000",
    ...
    indentLevel: 0,
    isExpandable: true,
    isExpanded: true, // TreeGrid用: 初期展開
    isEditable: true,
    parentRowId: null,
    dimensionValueId: null,
    dimensionValueName: null,
    cells: createForecastExtendedCells(
      [1000, 1150, 1200, 1100, 1100, 1100, 1200, 1100, 1000, 1100, 1200, 1300],
      [1000, 1150, null, null, null, null, null, null, null, null, null, null]
    ),
    annualTotal: calcAnnualTotal([1000, 1150, 1200, 1100, 1100, 1100, 1200, 1100, 1000, 1100, 1200, 1300]),
  },
  {
    rowId: "row-sales-product-a",
    subjectId: "sub-sales",
    subjectCode: "1000",
    subjectName: "製品A",
    subjectClass: "BASE",
    ...
    dimensionValueId: "dim-product-a",
    dimensionValueName: "製品A",
    cells: createForecastExtendedCells(
      [600, 700, 750, 680, 680, 680, 750, 680, 600, 680, 750, 800],
      [600, 700, null, null, null, null, null, null, null, null, null, null]
    ),
    annualTotal: calcAnnualTotal([600, 700, 750, 680, 680, 680, 750, 680, 600, 680, 750, 800]),
  },
  {
    rowId: "row-sales-product-b",
    subjectId: "sub-sales",
    subjectCode: "1000",
    subjectName: "製品B",
    subjectClass: "BASE",
    ...
    isEditable: true,
    parentRowId: "row-sales",
    dimensionValueId: "dim-product-b",
    dimensionValueName: "製品B",
    cells: createForecastExtendedCells(
      [400, 450, 450, 420, 420, 420, 450, 420, 400, 420, 450, 500],
      [400, 450, null, null, null, null, null, null, null, null, null, null]
    ),
    annualTotal: calcAnnualTotal([400, 450, 450, 420, 420, 420, 450, 420, 400, 420, 450, 500]),
  },
  {
    rowId: "row-cogs",
    subjectId: "sub-cogs",
    ...
    dimensionValueName: null,
    cells: createForecastExtendedCells(
      [600, 680, 700, 650, 650, 650, 700, 650, 600, 650, 700, 750],
      [600, 680, null, null, null, null, null, null, null, null, null, null]
    ),
    annualTotal: calcAnnualTotal([600, 680, 700, 650, 650, 650, 700, 650, 600, 650, 700, 750]),
  },
  {
    rowId: "row-cogs-material",
    subjectId: "sub-cogs",
    subjectCode: "2000",
    subjectName: "材料費",
    subjectClass: "BASE",
    ...
    dimensionValueId: "dim-material",
    dimensionValueName: "材料費",
    cells: createForecastExtendedCells(
      [400, 450, 470, 430, 430, 430, 470, 430, 400, 430, 470, 500],
      [400, 450, null, null, null, null, null, null, null, null, null, null]
    ),
    annualTotal: calcAnnualTotal([400, 450, 470, 430, 430, 430, 470, 430, 400, 430, 470, 500]),
  },
  {
    rowId: "row-cogs-labor",
    subjectId: "sub-cogs",
    subjectCode: "2000",
    subjectName: "労務費",
    subjectClass: "BASE",
    ...
    isEditable: true,
    parentRowId: "row-cogs",
    dimensionValueId: "dim-labor",
    dimensionValueName: "労務費",
    cells: createForecastExtendedCells(
      [200, 230, 230, 220, 220, 220, 230, 220, 200, 220, 230, 250],
      [200, 230, null, null, null, null, null, null, null, null, null, null]
    ),
    annualTotal: calcAnnualTotal([200, 230, 230, 220, 220, 220, 230, 220, 200, 220, 230, 250]),
  },
  {
...
export class MockForecastBffClient implements ForecastBffClient {
  ...
  async getGrid(_request: BffForecastGridRequest): Promise<BffForecastGridResponse> {
    ...
    return {
      ...
      // TreeGrid用: すべての行を返す（TreeGridが自身で階層を管理）
      rows: this.rows,
  ...
  async getBudgetCompare(request: BffForecastBudgetCompareRequest): Promise<BffForecastBudgetCompareResponse> {
    ...
    const forecastRows = this.rows.filter(r => r.parentRowId === null)
  ...
  async getPreviousCompare(request: BffForecastPreviousCompareRequest): Promise<BffForecastPreviousCompareResponse> {
    ...
    const currentRows = this.rows.filter(r => r.parentRowId === null)
    const periods = createForecastPeriods()
