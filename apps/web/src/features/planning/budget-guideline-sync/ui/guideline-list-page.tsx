    ...
    <div className="min-h-screen bg-background p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-balance text-3xl font-bold tracking-tight text-foreground">予算ガイドライン (SyV)</h1>
            <p className="text-pretty mt-2 text-muted-foreground">中期経営計画と年度予算の間に位置する指針を管理（Syncfusion版）</p>
          </div>
                  ...
                  {loading ? (
                    ...
                    events.map((event) => (
                      <TableRow
                        ...
                        onClick={() => (window.location.href = `/planning/guideline-sync/${event.id}`)}
                      >
